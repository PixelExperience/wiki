...
* A relatively recent 64-bit computer [Linux - Ubuntu Prefered | Windows - WSL (Ubuntu) | MacOS (LinuxVM/BareMetal Linux OS)] with atleast 16GB of RAM and about 250 GB of free storage (more if you enable `ccache`
 or build for multiple devices). The less RAM you have, the longer the build will take. Enabling ZRAM can be helpful. Using SSDs results in considerably faster
